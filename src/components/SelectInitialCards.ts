    ...
    getAfterPreludes: function() {
      ...
      for (const prelude of this.selectedPrelude) {
        ...
        case CardName.HUGE_ASTEROID:
          result -= 5;
          break;
        case CardName.HUGE_ASTEROID_REBALANCED:
          result -= 2;
          break;
        case CardName.DONATION:
          result += 21;
          break;
        case CardName.DONATION_REBALANCED:
          result += 23;
          break;
        ...
        case CardName.LOAN:
          result += 30;
          break;
        case CardName.LOAN_REBALANCED:
          result += 32;
          break;
        case CardName.METALS_COMPANY_REBALANCED:
          result += 2;
          break;
        case CardName.POLAR_INDUSTRIES_REBALANCED:
          result += 5;
          break;
        case CardName.SOCIETY_SUPPORT_REBALANCED:
          result -= 3;
          break;
        case CardName.SELF_SUFFICIENT_SETTLEMENT_REBALANCED:
          result += 3;
          break;
        ...
        case CardName.THARSIS_REPUBLIC:
          ...
          case CardName.EARLY_SETTLEMENT_REBALANCED:
            result += 3;
            break;
          }
          break;
        case CardName.PHARMACY_UNION:
          ...
          case CardName.BIOFUELS_REBALANCED:
