...
generateVueClass(
  'src/components/SpectatorHome',
  require('./build/src/components/SpectatorHome').SpectatorHome,
  [],
);
generateVueClass(
...
generateVueClass(
  'src/components/overview/SpectatorOverview',
  require('./build/src/components/overview/SpectatorOverview').SpectatorOverview,
  [],
);
generateVueClass(
