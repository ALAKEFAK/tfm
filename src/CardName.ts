export enum CardName {
    ...
    // Rebalanced corps
    APHRODITE_REBALANCED = 'Aphrodite(⚖)',
    ARCADIAN_COMMUNITIES_REBALANCED = 'Arcadian Communities(⚖)',
    ARIDOR_REBALANCED = 'Aridor(⚖)',
    ARKLIGHT_REBALANCED = 'Arklight(⚖)',
    ASTRODRILL_REBALANCED = 'Astrodrill(⚖)',
    CELESTIC_REBALANCED = 'Celestic(⚖)',
    CHEUNG_SHING_MARS_REBALANCED = 'Cheung Shing MARS(⚖)',
    ECOLINE_REBALANCED = 'EcoLine(⚖)',
    ...
    PHOBOLOG_REBALANCED = 'PhoboLog(⚖)',
    POINT_LUNA_REBALANCED = 'Point Luna(⚖)',
    POLYPHEMOS_REBALANCED = 'Polyphemos(⚖)',
    POSEIDON_REBALANCED = 'Poseidon(⚖)',
    PRISTAR_REBALANCED = 'Pristar(⚖)',
    RECYCLON_REBALANCED = 'Recyclon(⚖)',
    ROBINSON_INDUSTRIES_REBALANCED = 'Robinson Industries(⚖)',
    SPLICE_REBALANCED = 'Splice(⚖)',
    STORMCRAFT_INCORPORATED_REBALANCED = 'Stormcraft Incorporated(⚖)',
    TERRALABS_RESEARCH_REBALANCED = 'Terralabs Research(⚖)',
    THARSIS_REPUBLIC_REBALANCED = 'Tharsis Republic(⚖)',
    THORGATE_REBALANCED = 'Thorgate(⚖)',
    UNITED_NATIONS_MARS_INITIATIVE_REBALANCED = 'United Nations Mars Initiative(⚖)',
    ...
    BIOSPHERE_SUPPORT_REBALANCED = 'Biosphere Support(⚖)',
    DOME_FARMING_REBALANCED = 'Dome Farming(⚖)',
    DONATION_REBALANCED = 'Donation(⚖)',
    EARLY_SETTLEMENT_REBALANCED = 'Early Settlement(⚖)',
    ...
    OUTDOOR_SPORTS_REBALANCED = 'Outdoor Sports(⚖)',
    ...
    SABOTAGE_REBALANCED = 'Sabotage(⚖)',
    SECURITY_FLEET_REBALANCED = 'Security Fleet(⚖)',
