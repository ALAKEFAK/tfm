...
import {AstrodrillRebalanced} from '../../../../src/cards/rebalanced/rebalanced_corporation/AstrodrillRebalanced';
...
describe('AstrodrillRebalanced', function() {
  let card : AstrodrillRebalanced; let player : Player;

  beforeEach(function() {
    card = new AstrodrillRebalanced();
  ...
  it('Starts with 4 asteroid resources', function() {
