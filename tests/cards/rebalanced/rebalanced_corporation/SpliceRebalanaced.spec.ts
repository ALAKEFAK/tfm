...
import {SpliceRebalanced} from '../../../../src/cards/rebalanced/rebalanced_corporation/SpliceRebalanced';
...
describe('SpliceRebalanced', function() {
  let card : SpliceRebalanced; let player : Player; let player2 : Player;

  beforeEach(function() {
    card = new SpliceRebalanced();
