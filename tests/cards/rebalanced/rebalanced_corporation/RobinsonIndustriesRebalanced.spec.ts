...
import {RobinsonIndustriesRebalanced} from '../../../../src/cards/rebalanced/rebalanced_corporation/RobinsonIndustriesRebalanced';
...
describe('RobinsonIndustriesRebalanced', function() {
  let card : RobinsonIndustriesRebalanced; let player : Player;

  beforeEach(function() {
    card = new RobinsonIndustriesRebalanced();
