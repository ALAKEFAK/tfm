...
export const PlayerTags = Vue.component('player-tags', {
  ...
  methods: {
    ...
    showEscapeVelocity: function(): boolean {
      return this.player.game.gameOptions.escapeVelocityMode;
    },
    ...
    getEscapeVelocityPenalty: function(): number {
      return this.player.victoryPointsBreakdown.escapeVelocity ?? 0;
    },
    getEscapeVelocityDetail: function(): string {
      let detail = '';
      if (this.player.game.gameOptions.escapeVelocityMode) {
        detail += `Escape velocity penalty: ${this.player.victoryPointsBreakdown.escapeVelocity}\n`;
        detail += `Time limit: ${this.player.game.gameOptions.escapeVelocityThreshold} min\n`;
      }
      return detail;
    },
  ...
  template: `
        <div class="player-tags">
            <div class="player-tags-main">
                ...
                <tag-count v-if="showEscapeVelocity()"
                  class="tooltip tooltip-bottom" :data-tooltip="getEscapeVelocityDetail()"
                  :tag="'escape'" :count="getEscapeVelocityPenalty()" :size="'big'" :type="'main'" />
