...
<div class="start-screen">
  <div v-i18n class="start-screen-links">
    <div class="start-screen-header start-screen-link--title">
      <div class="start-screen-title-top">REBALANCED</div>
    ...
    <a class="start-screen-link start-screen-link--changelog" href="https://rebalanced-mars.notion.site/Rebalanced-Mars-36bdaa3aa2ce4beaac29f3c3adfd6df4" target="_blank" v-i18n>What's Rebalanced?</a>
    <a class="start-screen-link start-screen-link--chat" href="https://discord.gg/mxCCb8rd7C" target="_blank" v-i18n>Rebalanced Discord</a>
