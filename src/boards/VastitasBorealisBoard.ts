...
export class VastitasBorealisBoard extends Board {
  public static newInstance(shuffleTileMode: ShuffleTileOptionType, rng: Random, includeVenus: boolean): VastitasBorealisBoard {
    ...
    builder.setMustBeLandSpaces(SpaceName.ELYSIUM_MONS_VASTITAS_BOREALIS, SpaceName.ALBA_FOSSAE, SpaceName.CERANIUS_FOSSAE, SpaceName.ALBA_MONS, SpaceName.VASTITAS_BOREALIS_NORTH_POLE);
