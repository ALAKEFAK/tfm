    ...
    <div :class="getGameBoardClassName()">
        ...
        <div class="board" id="main_board">
            ...
            <svg id="board_legend" height="550" width="630" class="board-legend">
                ...
                <g v-if="boardName === 'amazonis'" id="arbor_tholus" transform="translate(85, 175)">
                  <text class="board-caption" dx="47">
                      <tspan dy="-7">Arbor</tspan>
                      <tspan dy="12" x="48">Tholus</tspan>
                  </text>
                  <line x1="90" y1="-3" x2="160" y2="2" class="board-line"></line>
                  <text x="158" y="5" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'amazonis'" id="pindus_tholus" transform="translate(398, 348)">
                  <text class="board-caption" dx="104">
                      <tspan dy="25">Pindus</tspan>
                      <tspan dy="12" dx="-25">Tholus</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="109" y2="30" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'amazonis'" id="anseris_mons" transform="translate(420, 306)">
                  <text class="board-caption" dx="90">
                      <tspan dy="-85">Anseris</tspan>
                      <tspan dy="12" dx="-25">Mons</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="97" y2="-77" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'amazonis'" id="ulysses_tholus" transform="translate(322, 389)">
                  <text class="board-caption" dx="168">
                      <tspan dy="13">Ulysses</tspan>
                      <tspan dy="12" dx="-35">Tholus</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="166" y2="16" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'v. borealis'" id="elysium_mons_v_borealis" transform="translate(420, 142)">
                  <text class="board-caption" dx="45">
                      <tspan dy="0">Elysium</tspan>
                      <tspan dy="12" dx="-25">Mons</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="40" y2="-3" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'v. borealis'" id="alba_fossae" transform="translate(400, 182)">
                  <text class="board-caption" dx="100">
                      <tspan dy="0">Alba</tspan>
                      <tspan dy="12" dx="-20">Fossae</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="95" y2="-3" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'v. borealis'" id="ceranius_fossa" transform="translate(150, 265)">
                  <text class="board-caption" dx="-70">
                      <tspan dy="-10">Ceranius</tspan>
                      <tspan dy="12" dx="-50">Fossae</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="-30" y2="-3" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'v. borealis'" id="alba_mons" transform="translate(200, 265)">
                  <text class="board-caption" dx="-110">
                      <tspan dy="60">Alba</tspan>
                      <tspan dy="12" dx="-20">Mons</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="-80" y2="60" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'terra cimmeria'" id="tyrrhenus_mons" transform="translate(150, 265)">
                  <text class="board-caption" dx="-70">
                      <tspan dy="-10">Tyrrhenus</tspan>
                      <tspan dy="12" dx="-50">Mons</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="-30" y2="-3" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'terra cimmeria'" id="hadriacus_mons" transform="translate(150, 350)">
                  <text class="board-caption" dx="-70">
                      <tspan dy="-10">Hadriacus</tspan>
                      <tspan dy="12" dx="-45">Mons</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="-30" y2="-3" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'terra cimmeria'" id="apollinaris_mons" transform="translate(448, 268)">
                  <text class="board-caption" dx="55">
                      <tspan dy="-50">Apollinaris</tspan>
                      <tspan dy="12" dx="-30">Mons</tspan>
                  </text>
                  <line x1="0" y1="-3" x2="75" y2="-45" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>

                <g v-if="boardName === 'terra cimmeria'" id="albor_tholus" transform="translate(322, 143)">
                  <text class="board-caption" dx="25">
                      <tspan dy="-73">Albor</tspan>
                      <tspan dy="12" dx="-20">Tholus</tspan>
                  </text>
                  <line x1="3" y1="-3" x2="30" y2="-65" class="board-line"></line>
                  <text x="0" y="0" class="board-caption board_caption--black">&#x25cf;</text>
                </g>
