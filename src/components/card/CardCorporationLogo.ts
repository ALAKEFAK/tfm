...
export const CardCorporationLogo = Vue.component('CardCorporationLogo', {
  ...
  methods: {
    getHtmlContent: function(): string {
      ...
      case CardName.CELESTIC_REBALANCED:
      ...
      case CardName.INVENTRIX_REBALANCED:
      ...
      case CardName.TERRALABS_RESEARCH_REBALANCED:
      ...
      case CardName.ARCADIAN_COMMUNITIES_REBALANCED:
      ...
      case CardName.SPLICE_REBALANCED:
      ...
      case CardName.STORMCRAFT_INCORPORATED_REBALANCED:
      ...
      case CardName.THARSIS_REPUBLIC_REBALANCED:
      ...
      case CardName.MONS_INSURANCE_REBALANCED:
      ...
      case CardName.SCAVENGERS:
        ...
        <div class="scav0">SCAVENGERS</div>
